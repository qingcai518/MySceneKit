...
class Chapter12Controller: UIViewController {
    ...
    func setupScene() {
        ...
        self.imageMaterial.diffuse.contents = UIImage(named: "test1.jpg")
...
extension Chapter12Controller: SCNSceneRendererDelegate {
